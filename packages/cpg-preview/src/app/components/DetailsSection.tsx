...
import { useResolvedPath, useNavigate, Route, Routes, MemoryRouter, useLocation } from 'react-router-dom';
  ...
  return (
    <div className="details-section">
      ...
      <div className="details-container">
        <MemoryRouter>
          <Routes>
            <Route path="/" element={<NodeDetails details={details} resolver={resolver} />}/>
            <Route path="/:id" element={<InputDetails resolver={resolver}/>}/>
          </Routes>
        </MemoryRouter>
      </div>
    </div>
