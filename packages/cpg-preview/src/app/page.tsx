  ...
  return (
    <div className='app-container'>
      ...
      <div className='content-container'>
        {resolver && planDefinition ? <FlowDisplay resolver={resolver} planDefinition={planDefinition} setDetails={setDetails} /> : <LoadIndicator/>}
        <DetailsSection details={details}></DetailsSection>
      </div>
    </div>
  )
}
