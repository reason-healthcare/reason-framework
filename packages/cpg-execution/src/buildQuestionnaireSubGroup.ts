...
export const buildQuestionnaireItemsSubGroup = (structureDefinition: fhir4.StructureDefinition, group: fhir4.ElementDefinition[]): fhir4.QuestionnaireItem[] => {
  ...
  const subGroup = group.map((element) => {
    let item = {
      linkId: uuidv4(),
